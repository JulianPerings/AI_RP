...
## Core Entity Models
- `player_character.py` - PlayerCharacter (name, class, level, health, gold, race, faction, reputation)
...
- **ItemInstance**: Actual item in the world (based on template) - unique with owner, location, enchantments
...
- Instance level: Update `enchantments` in ItemInstance (affects only that item)
